package top.anets.oauth2.service.customClient;
...
public class SysClientDetailService {
    ...
    public BaseClientDetails selectById(String clientId) {
        ...
        clientDetails.setClientId("mxg-blog-admin");
        // 这个客户端秘钥和密码一样存BCryptPasswordEncoder加密后的接口，具体看定义的加密器
        clientDetails.setClientSecret("$2a$10$uA51hWL5yusFBoEvZOAZbeaYYqUaFV7xjdDB8GA.4iViNiCSK9xKO");
        ...
        sets.add("https://baidu.com");
        clientDetails.setRegisteredRedirectUri(sets);



//        下面这段话是自动授权批准(登陆成功之后不用跳转到授权页面)
